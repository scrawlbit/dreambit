...
{
    internal class DrawBatchDefinition
    {
        public DrawBatchDefinition(
        ...
        {
            if (obj is DrawBatchDefinition definition)
            {
        ...
        public static bool operator ==(DrawBatchDefinition a, DrawBatchDefinition b)
        {
            return Equals(a, b);
        }
        public static bool operator !=(DrawBatchDefinition a, DrawBatchDefinition b)
